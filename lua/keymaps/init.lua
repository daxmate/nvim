...
keymap("n", "<leader>ct", ":CMakeTest -V -R ", opts)
...
keymap("n", "<F3>", function() require("dap").step_over() end, silent_opts)
keymap("n", "<F2>", function() require("dap").step_into() end, silent_opts)
keymap("n", "<F4>", function() require("dap").step_out() end, silent_opts)
...
keymap("n", "<leader>dr", function() require("dap").repl.open() end, silent_opts)
keymap("n", "<leader>dl", function() require("dap").run_last() end, silent_opts)
keymap("n", "<leader>dc", function() require("dap").run_to_cursor() end,
       silent_opts)
keymap({"n", "v"}, "<leader>dh",
       function() require("dap.ui.widgets").hover() end, silent_opts)
keymap({"n", "v"}, "<leader>dp",
       function() require("dap.ui.widgets").preview() end, silent_opts)
...
keymap("n", "<leader>uo", function() require("dapui").open() end, silent_opts)
keymap("n", "<leader>uc", function() require("dapui").close() end, silent_opts)
